      ...
      case 'summary':
        return cvData.summary && (
          <section key="summary" className="mb-8">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-3 text-black border-b border-black pb-1">Tóm tắt</h3>
      ...
      case 'skills':
        return cvData.skills.length > 0 && (
          <section key="skills" className="mb-8">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-3 text-black border-b border-black pb-1">Kỹ năng</h3>
      ...
      case 'experience':
        return cvData.experience.length > 0 && (
          <section key="experience" className="mb-8">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-4 text-black border-b border-black pb-1">Kinh nghiệm</h3>
      ...
      case 'projects':
        return cvData.projects.length > 0 && (
          <section key="projects" className="mb-8">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-4 text-black border-b border-black pb-1">Dự án</h3>
      ...
      case 'education':
        return cvData.education.length > 0 && (
          <section key="education" className="mb-8">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-4 text-black border-b border-black pb-1">Học vấn</h3>
              ...
              {cvData.education.map((edu) => (
                <div key={edu.id} className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    ...
                    {edu.gpa && <div className="text-gray-600 text-xs mt-1">GPA: {edu.gpa}</div>}
                  </div>
                </div>
              ))}
            </div>
      ...
      case 'certifications':
        return cvData.certifications.length > 0 && (
          <section key="certifications" className="mb-8">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-3 text-black border-b border-black pb-1">Chứng chỉ</h3>
      ...
      case 'languages':
        return cvData.languages.length > 0 && (
          <section key="languages" className="mb-8">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-3 text-black border-b border-black pb-1">Ngoại ngữ</h3>
